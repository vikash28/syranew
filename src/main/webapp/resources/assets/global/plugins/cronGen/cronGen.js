...
(function ($) {
    ...
    $.fn.extend({
        cronGen: function () {
            ...
            // Add an input
            var $i = $("<input>", { type: 'text', placeholder: 'Cron schedule', readonly: 'readonly' }).addClass("form-control").val($(that).val());
            $i.appendTo($g);
            // Add the button
            var $b = $("<button class=\"btn btn-default\" data-toggle=\"popover\"><i class=\"fa fa-edit\"></i></button>");
